<template>
  <div>
    ...
    <el-table :data="filterData" style="width: 100%">
      ...
      <el-table-column prop="surplus_num" label="库存"> </el-table-column>
...
<script>
import { getCommodityList, delCommondity } from "@/api/scheduled.js";
import edit from "@/view/components/scheduled/comments/commondityedit";
