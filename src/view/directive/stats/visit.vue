<template>
  <div class="app-container">
    <el-tabs v-model="tabIndex">
      <el-tab-pane label="最近一个月到店" name="1"></el-tab-pane>
      <el-tab-pane label="30天以上未到店" name="2"></el-tab-pane>
      <el-tab-pane label="60天以上未到店" name="3"></el-tab-pane>
      <el-tab-pane label="90天以上未到店" name="4"></el-tab-pane>
    </el-tabs>
...
export default {
  ...
  watch: {
    tabIndex (v) {
      switch (v) {
        case '1':
          this.curList = this.allList.recent || []
          break
        case '2':
          this.curList = this.allList.day30 || []
          break
        case '3':
          this.curList = this.allList.day60 || []
          break
        case '4':
          this.curList = this.allList.day90 || []
          break
        default:break
      }
